...
export const Bases = createMonomerGroup(MonomerType.Base, {
  ...
  DNA_K: { alias: 'DNA_K', testId: '_G___Guanine_T___Thymine' },
  DNA_W: { alias: 'DNA_W', testId: '_A___Adenine_T___Thymine' },
  DNA_Y: { alias: 'DNA_Y', testId: '_C___Cytosine_T___Thymine' },
  RNA_N: {
    alias: 'RNA_N',
  ...
  RNA_K: { alias: 'RNA_K', testId: '_G___Guanine_U___Uracil' },
  RNA_W: { alias: 'RNA_W', testId: '_A___Adenine_U___Uracil' },
  RNA_Y: { alias: 'RNA_Y', testId: '_C___Cytosine_U___Uracil' },
