...
export const Peptides = {
  ...
  Bal: { alias: 'Bal', testId: '' } as Monomer,
  ...
  meE: { alias: 'meE', testId: 'meE___N-Methyl-Glutamic acid' } as Monomer,
  meM: { alias: 'meM', testId: 'meM___N-Methyl-Methionine' } as Monomer,
  meR: { alias: 'meR', testId: '' } as Monomer,
  meS: { alias: 'meS', testId: 'meS___N-Methyl-Serine' } as Monomer,
  Nal: { alias: 'Nal', testId: '' } as Monomer,
  LysiPr: {
    alias: 'LysiPr',
  ...
  Hhs: { alias: 'Hhs', testId: 'Hhs___homohistidine' } as Monomer,
  His1Me: {
    alias: 'His1Me',
