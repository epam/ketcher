...
util.Box2Abs.fromRelBox = function (relBox) {
	...
	return new util.Box2Abs(relBox.x, relBox.y, relBox.x + relBox.width, relBox.y + relBox.height);
};
...
util.Vec2.shiftRayBox = function (/*util.Vec2*/p, /*util.Vec2*/d, /*util.Box2Abs*/bb) {
	util.assertDefined(p);
	util.assertDefined(d);
