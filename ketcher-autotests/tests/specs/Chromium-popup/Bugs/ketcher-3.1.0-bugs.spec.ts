...
test.describe('Ketcher bugs in 3.1.0', () => {
  ...
  test(
    'Case 1: Circular hydrogen bond connection between three (or more) chains, those hydrogen bonds is considered as side chain connection for layout purposes',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
  ...
  test(
    'Case 2: Unknown monomer and CHEM not overlap to each other if both are the side chain for same chain',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 3: Unknown monomer and CHEM not overlap to each other if both are the side chain for same chain (Additional case)',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 4: Nucleotide not become antisense oriented if have hydrogen connection to sugar',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 6: Create Antisense Strand option is disabled even if antisensless base present in chain selection',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 7: Color schema for Favorites tab at RNA Library is like in the library for Peptides',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 8: Changing any parameter at Settings not cause Undo/Redo work wrong (or delete undo history)',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 9: Chain bonds not appear on Sequence screenshots',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 10: There is no gap between button and drop-down list of Macro modes',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    `Case 11: System not shows Edit S-Group option for bond of molecule if it has attachment point`,
    { tag: ['@chromium-popup'] },
    async () => {
      /*
  ...
  test(
    `Case 12: For D-OAla named monomer it should be D-Lactic acid name in preview tooltip`,
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6600
  ...
  test(
    `Case 13: Separate selenocysteine from cysteine and pyrrolysine from lysine`,
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6600
  ...
  test(
    'Case 14: Selection work in sequence editing with Shift+Up/Down arrow combination',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    `Case 15: Long bond not appears behind the structure after Copy-Paste in Flex Mode`,
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6600
  ...
  test(
    'Case 16: Removing peptide from sense/antisence chain not cause unnessussary phosphate removal',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 17: Adding peptide between RNA and - symbol not breaks sense/antisense chain',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 18: System split chian pair on two if - symbol deleted',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 19: System not merge two antisense chains if separator monomer got deleted',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 20: Adding second chain with antisese chain to the canvas not cause layout problem',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 22: Undo of deleted bond on sequence mode not causes "ghost" monomer appearence on the canvas',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 23: Connection points not appear visually disconnected when moving monomers in Flex and Snake mode',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
  ...
  test(
    'Case 24: Peptide sequence not pasting directly on canvas',
    { tag: ['@chromium-popup'] },
    async () => {
      /*
       * Test case: https://github.com/epam/ketcher/issues/6602
