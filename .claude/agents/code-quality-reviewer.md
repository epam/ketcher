...
description: "Reviews a change for quality and maintainability: readability, naming, duplication, error handling, TypeScript and React practice. One of the four reviewers /review-pr runs."
