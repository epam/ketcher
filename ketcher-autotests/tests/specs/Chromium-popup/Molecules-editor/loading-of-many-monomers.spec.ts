...
test.describe('Loading of many monomers to Micro', () => {
  ...
  test('Case 1: Check that we can open a chain of 500 monomers in Micro mode', async () => {
    /*
     * Version 3.7
  ...
  test('Case 2: Check that we can open a chain of 1000 monomers in Micro mode', async () => {
    /*
     * Version 3.7
     * Test case: https://github.com/epam/ketcher/issues/7351
  ...
  test('Case 3: Check that we can open a chain of 1500 monomers in Micro mode', async () => {
    /*
     * Version 3.7
     * Test case: https://github.com/epam/ketcher/issues/7351
  ...
  test('Case 4: Check that we can open a chain of 2000 monomers in Micro mode', async () => {
    /*
     * Version 3.7
     * Test case: https://github.com/epam/ketcher/issues/7351
  ...
  test('Case 5: Check that we can open a chain of 2500 monomers in Micro mode', async () => {
    /*
     * Version 3.7
     * Test case: https://github.com/epam/ketcher/issues/7351
  ...
  test('Case 6: Check that we can open a chain of 3000 monomers in Micro mode', async () => {
    /*
     * Version 3.7
     * Test case: https://github.com/epam/ketcher/issues/7351
  ...
  test('Case 7: Check that we can open a chain of 3500 monomers in Micro mode', async () => {
    /*
     * Version 3.7
     * Test case: https://github.com/epam/ketcher/issues/7351
