...
test.describe('Drag and drop Atom on canvas', () => {
  ...
  test('The Oxygen atom replaces the Nitrogen atom', async ({ page }) => {
    ...
    */
    ...
    const oxygenCoordinates = { x: x + 100, y };
  ...
  test.skip('The Nitrogen atom replaces the FMOC functional group', async ({
    page,
  }) => {
    /*
    ...
    */
    ...
    const { x, y } = await getCoordinatesOfTheMiddleOfTheScreen(page);
    const nitrogenCoordinates = { x: x + 100, y };
  ...
  test.skip('The Nitrogen atom replaces the formic acid', async ({ page }) => {
    /*
  ...
  test('The Oxygen atom replaces the Bromine atom', async ({ page }) => {
    ...
    */
    ...
    await selectAtomInToolbar(AtomButton.Oxygen, page);
    await moveMouseToTheMiddleOfTheScreen(page);
    const oxygenCoordinates = { x: x + 150, y };
    await page.mouse.click(oxygenCoordinates.x, oxygenCoordinates.y);
  ...
  test.skip('The Oxygen atom replaces the Cbz functional group', async ({
    page,
  }) => {
    /*
