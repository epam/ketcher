...
const monomerColors: Record<string, MonomerColorScheme> = {
  ...
  colorCM: { regular: '#FFF600', hover: '#0097A8' },
  colorC: { regular: '#BF00FF', hover: '#0097A8' },
  colorDQ: { regular: '#EDB4ED', hover: '#0097A8' },
  colorD: { regular: '#FF8C69', hover: '#0097A8' },
  colorEN: { regular: '#800080', hover: '#0097A8' },
  colorE: { regular: '#DC143C', hover: '#0097A8' },
  colorFY: { regular: '#008A00', hover: '#0097A8' },
  colorGX: { regular: '#E1E6ED', hover: '#CAD3E0' },
  colorG: { regular: '#BDB76B', hover: '#0097A8' },
  colorH: { regular: '#007FFF', hover: '#0097A8' },
  colorILV: { regular: '#FFD700', hover: '#0097A8' },
  colorL: { regular: '#7FFF00', hover: '#0097A8' },
  colorI: { regular: '#4CBB17', hover: '#0097A8' },
  colorKR: { regular: '#0A12FF', hover: '#0097A8' },
  colorK: { regular: '#B0E0E6', hover: '#0097A8' },
  colorO: { regular: '#2A52BE', hover: '#0097A8' },
  colorP: { regular: '#D2D900', hover: '#0097A8' },
  colorST: { regular: '#FF00FF', hover: '#0097A8' },
  colorS: { regular: '#9966CC', hover: '#0097A8' },
  colorY: { regular: '#D65CBC', hover: '#0097A8' },
  colorW: { regular: '#98FF98', hover: '#0097A8' },
  colorU: { regular: '#CA7DE3', hover: '#0097A8' },
...
export const defaultTheme: EditorTheme = {
  ...
  monomer: {
    color: {
      ...
      C: monomerColors.colorC,
      M: monomerColors.colorCM,
      D: monomerColors.colorD,
      Q: monomerColors.colorDQ,
      E: monomerColors.colorE,
      N: monomerColors.colorEN,
      F: monomerColors.colorFY,
      Y: monomerColors.colorY,
      G: monomerColors.colorG,
      X: monomerColors.colorGX,
      H: monomerColors.colorH,
      I: monomerColors.colorI,
      L: monomerColors.colorL,
      V: monomerColors.colorILV,
      K: monomerColors.colorK,
      R: monomerColors.colorKR,
      O: monomerColors.colorO,
      P: monomerColors.colorP,
      S: monomerColors.colorS,
