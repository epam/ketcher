...
// test(`should return only coordinates for benzene ring in ascending order`, async ({
//   page,
// }) => {
//   const offset = {
//     x1: 50,
...
// test(`should throw error in case we draw atom below left/top toolbars`, async ({
//   page,
// }) => {
//   const offsetX = -10;
//   const offsetY = -10;
...
// test(`should throw error in case we pass incorrect attributes to find atoms`, async ({
//   page,
// }) => {
//   const offsetX = 10;
//   const offsetY = 10;
