...
// test(`should find first available atom for complex structures (with multiple atoms)`, async ({
//   page,
// }) => {
//   const offsetAtomX = 100;
//   const offsetAtomY = 150;
...
// test(`should find atom by custom attributes`, async ({ page }) => {
//   const offsetAtomX = 100;
//   const offsetAtomY = 150;
...
// test(`should throw an error STRUCTURE_NOT_FOUND_ERROR in case we pass empty object `, async ({
//   page,
// }) => {
//   const offsetAtomX = 100;
//   const offsetAtomY = 150;
...
// test(`should throw an error in case canvas IS EMPTY`, async ({ page }) => {
//   await waitForPageInit(page);
...
// // flaky test
// test(`should throw an error when the position of the atom below / above top / left toolbar`, async ({
//   page,
// }) => {
...
// test(`should throw an error in case we pass incorrect attributes`, async ({
//   page,
// }) => {
//   const offsetAtomX = 10;
//   const offsetAtomY = 10;
