...
chem.Element.elements = new Map({
	...
	17: new chem.Element('Cl', 3, 7, true, '#1fd01f'),
	...
	104: new chem.Element('Rf', 7, 4, false, '#4dc2ff'),
	105: new chem.Element('Db', 7, 5, false, '#4da6ff'),
	106: new chem.Element('Sg', 7, 6, false, '#2194d6'),
	107: new chem.Element('Bh', 7, 7, false, '#267dab'),
	108: new chem.Element('Hs', 7, 8, false, '#266696'),
